...
os.system('rm -rf list1.txt')
os.system('id -u > list1.txt')
uidd = open('list1.txt', 'r')
for j in uidd:
    sp = j.split()
...
def chk(): 
  ...
  print("\n\n\x1b[37;1mYour ID : "+id) 
  try: 
    httpCaht = requests.get("https://raw.githubusercontent.com/533hacker/Active_1/main/list1.txt").text 
    if id in httpCaht: 
...
vuln = '\x1b[32mVuln'
os.system('clear')
logo = '--------------------------------------------------\n\x1b[1;97m\xe2\x9e\xa3 Author   : Hama.ZW     \n\x1b[1;97m\xe2\x9e\xa3 Telegram  : @kurdhacker_hama_bn_dlaj \n\x1b[1;97m\xe2\x9e\xa3 Telegram group   @kurdhackerzw:\n\x1b[1;97m\xe2\x9e\xa3 Note  : This Tool crack nubmer iraq\n\x1b[1;97m--------------------------------------------------\n'
logo2 = ""
CorrectUsername = 'Hama.zw'
CorrectPassword = 'Kurd Up'
os.system('clear')
print logo2
loop = 'true'
while loop == 'true':
